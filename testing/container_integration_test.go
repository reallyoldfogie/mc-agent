...
func TestChestInteraction(t *testing.T) {
	...
	serverCfg.CacheDir = filepath.Join(cwd, ".server_cache", "TestChestInteraction", "1.21.5")
...
func TestChestWithItems(t *testing.T) {
	...
	serverCfg.PullImage = false
	serverCfg.CacheDir = filepath.Join(cwd, ".server_cache", "TestChestWithItems", "1.21.5")
	RequireIntegrationEnv(t, serverCfg)
