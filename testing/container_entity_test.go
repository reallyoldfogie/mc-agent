...
func TestHorse_Standalone(t *testing.T) {
	env := setupStandaloneTestForEntity(t, "entity_horse")
	defer env.Cancel()
...
func TestChestBoat_Standalone(t *testing.T) {
	env := setupStandaloneTestForEntity(t, "entity_chest_boat")
	defer env.Cancel()
...
func TestChestMinecart_Standalone(t *testing.T) {
	env := setupStandaloneTestForEntity(t, "entity_chest_minecart")
	defer env.Cancel()
