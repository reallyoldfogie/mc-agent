...
func TestStonecutter_Standalone(t *testing.T) {
	env := setupStandaloneTest(t, "stonecutter")
	defer env.Cancel()
...
func TestLoom_Survival(t *testing.T) {
	...
	env := setupStandaloneTestWithMode(t, "loom", "survival")
	defer env.Cancel()
...
func TestLoom_Standalone(t *testing.T) {
	env := setupStandaloneTest(t, "loom")
	defer env.Cancel()
...
func TestEnchantingTable_Standalone(t *testing.T) {
	env := setupStandaloneTest(t, "enchanting_table")
	defer env.Cancel()
...
func TestBeacon_Standalone(t *testing.T) {
	env := setupStandaloneTest(t, "beacon")
	defer env.Cancel()
