...
// 		fmt.Printf("unknown entity ID %v\n", pkt.Type)
// 		return nil
// 	}
...
// 		fmt.Printf("cannot handle position update for unknown entity %d", pkt.ID)
// 		return nil
// 	}
...
// 		fmt.Printf("cannot handle position look update for unknown entity %d", pkt.ID)
// 		return nil
// 	}
...
// 		fmt.Printf("cannot handle look update for unknown entity %d", pkt.ID)
// 		return nil
// 	}
