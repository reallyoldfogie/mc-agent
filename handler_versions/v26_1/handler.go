...
// Handler implements models.VersionHandler for Minecraft 26.1.
type Handler struct {
...
// NewHandler creates a new version handler for 26.1.
// The packetMgr parameter should be the mc-protocol-go PacketMgr for 26.1.
...
// playHandler implements models.PlayHandler for 26.1.
...
// In 26.1, CommonSettings has 9 fields (including ParticleStatus).
...
// ParseUpdateRecipes parses a ClientboundDeclareRecipes packet for 26.1.
...
// BuildPlayerInfoPacket builds a PlayerInfo packet for replay recording (v26.1).
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v26.1).
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v26.1).
...
// ExtractPlayerInfoProperties extracts game profile properties from a PlayerInfo packet (v26.1).
...
// ParsePlayerInfo parses a complete PlayerInfo packet and extracts all entries and action data (v26.1).
