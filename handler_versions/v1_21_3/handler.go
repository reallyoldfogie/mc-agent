...
// Handler implements models.VersionHandler for Minecraft 1.21.3.
type Handler struct {
...
// playHandler implements models.PlayHandler for 1.21.3.
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v1.21.3).
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v1.21.3).
