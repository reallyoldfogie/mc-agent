...
// Handler implements models.VersionHandler for Minecraft 1.21.5.
type Handler struct {
...
// NewHandler creates a new version handler for 1.21.5.
// The packetMgr parameter should be the mc-protocol-go PacketMgr for 1.21.5.
...
// playHandler implements models.PlayHandler for 1.21.5.
...
// In 1.21.5, CommonSettings has 9 fields (including ParticleStatus).
...
// ParseUpdateRecipes parses a ClientboundDeclareRecipes packet for 1.21.5.
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v1.21.5).
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v1.21.5).
...
// actionHandler is implemented in actions.go
