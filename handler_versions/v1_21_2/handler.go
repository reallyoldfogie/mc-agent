...
// Handler implements models.VersionHandler for Minecraft 1.21.2.
type Handler struct {
...
// NewHandler creates a new version handler for 1.21.2.
// The packetMgr parameter should be the mc-protocol-go PacketMgr for 1.21.2.
...
// playHandler implements models.PlayHandler for 1.21.2.
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v1.21.2).
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v1.21.2).
...
// ExtractPlayerInfoProperties extracts game profile properties from a PlayerInfo packet (v1.21.2).
...
// ParsePlayerInfo parses a complete PlayerInfo packet and extracts all entries and action data (v1.21.2).
