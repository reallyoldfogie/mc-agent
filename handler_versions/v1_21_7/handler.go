...
// ParseUpdateRecipes parses a ClientboundDeclareRecipes packet for 1.21.7.
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v1.21.7).
