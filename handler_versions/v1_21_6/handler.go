...
// Handler implements models.VersionHandler for Minecraft 1.21.6.
type Handler struct {
...
// playHandler implements models.PlayHandler for 1.21.6.
...
// BuildPlayerInfoPacket builds a PlayerInfo packet for replay recording (v1.21.6).
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v1.21.6).
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v1.21.6).
...
// ExtractPlayerInfoProperties extracts game profile properties from a PlayerInfo packet (v1.21.6).
...
// ParsePlayerInfo parses a complete PlayerInfo packet and extracts all entries and action data (v1.21.6).
