...
// Handler implements models.VersionHandler for Minecraft 1.21.10.
type Handler struct {
...
// NewHandler creates a new version handler for 1.21.10.
// The packetMgr parameter should be the mc-protocol-go PacketMgr for 1.21.10.
...
// playHandler implements models.PlayHandler for 1.21.10.
...
// In 1.21.10, CommonSettings has 9 fields (including ParticleStatus).
...
// ParseUpdateRecipes parses a ClientboundDeclareRecipes packet for 1.21.10.
...
// BuildPlayerInfoPacket builds a PlayerInfo packet for replay recording (v1.21.10).
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v1.21.10).
...
// BuildEntityEquipmentPacket builds an EntityEquipment packet for replay recording (v1.21.10).
...
// ExtractPlayerInfoProperties extracts game profile properties from a PlayerInfo packet (v1.21.10).
...
// ParsePlayerInfo parses a complete PlayerInfo packet and extracts all entries and action data (v1.21.10).
