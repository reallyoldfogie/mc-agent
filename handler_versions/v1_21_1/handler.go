...
// Handler implements models.VersionHandler for Minecraft 1.21.1.
type Handler struct {
...
// playHandler implements models.PlayHandler for 1.21.1.
...
// BuildSpawnEntityPacket builds a SpawnEntity packet for replay recording (v1.21.1).
