...
func TestMovementHandler_SendPosition_PacketStructure(t *testing.T) {
	...
	// Verify packet ID is correct for 1.21.1
	if pkt.PacketID() != 26 {
		t.Errorf("Expected packet ID 26, got %d", pkt.PacketID())
	}
...
func TestMovementHandler_SendPositionAndRotation_PacketStructure(t *testing.T) {
	...
	// Verify packet ID is correct for 1.21.1
	if pkt.PacketID() != 27 {
		t.Errorf("Expected packet ID 27, got %d", pkt.PacketID())
	}
...
func TestMovementHandler_SendPlayerAbilities_PacketStructure(t *testing.T) {
	...
	// Verify packet ID is correct for 1.21.1
	if pkt.PacketID() != 35 {
		t.Errorf("Expected packet ID 35, got %d", pkt.PacketID())
	}
