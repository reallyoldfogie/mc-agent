...
// chatHandler implements common.ChatHandler for 1.21.4.
type chatHandler struct {
	packetMgr protocol_models.PacketMgr
}

// SendChat sends a chat message.
// In 1.21.4, chat messages require timestamps, salt, and signature fields for secure chat.
func (c *chatHandler) SendChat(conn models.PacketWriter, message string) error {
	...
	// Note: 1.21.4 does not have Checksum field (added in 1.21.5)
